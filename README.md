...
- Migration analyzer + interactive walkthrough for adopting composoft in existing React/Next.js codebases (v0 — analyzer + decision-driven walkthrough; block extractor and embeddable runtime in subsequent alphas).
...
- `@composoft/migrate` 0.1.0-alpha.4
